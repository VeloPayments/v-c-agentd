...
/**
 * \brief Failure encountered deleting data from the datastore.
 */
#define AGENTD_ERROR_DATASERVICE_MDB_DEL_FAILURE \
...
#define AGENTD_ERROR_DATASERVICE_INVALID_INDEX_ENTRY \
    AGENTD_STATUS_ERROR_MACRO(AGENTD_SERVICE_DATASERVICE, 0x0032U)

/**
 * \brief Crypto suite options could not be initialized.
 */
#define AGENTD_ERROR_DATASERVICE_VCCRYPT_SUITE_OPTIONS_INIT_FAILURE \
    AGENTD_STATUS_ERROR_MACRO(AGENTD_SERVICE_DATASERVICE, 0x0033U)

/**
 * \brief Parser options could not be initialized.
 */
#define AGENTD_ERROR_DATASERVICE_VCCERT_PARSER_OPTIONS_INIT_FAILURE \
    AGENTD_STATUS_ERROR_MACRO(AGENTD_SERVICE_DATASERVICE, 0x0034U)

/**
 * \brief Parser could not be initialized.
 */
#define AGENTD_ERROR_DATASERVICE_VCCERT_PARSER_INIT_FAILURE \
    AGENTD_STATUS_ERROR_MACRO(AGENTD_SERVICE_DATASERVICE, 0x0035U)

/**
 * \brief Missing block height field.
 */
#define AGENTD_ERROR_DATASERVICE_MISSING_BLOCK_HEIGHT \
    AGENTD_STATUS_ERROR_MACRO(AGENTD_SERVICE_DATASERVICE, 0x0036U)

/**
 * \brief Invalid block height value.
 */
#define AGENTD_ERROR_DATASERVICE_INVALID_BLOCK_HEIGHT \
    AGENTD_STATUS_ERROR_MACRO(AGENTD_SERVICE_DATASERVICE, 0x0037U)

/**
 * \brief Missing previous block field.
 */
#define AGENTD_ERROR_DATASERVICE_MISSING_PREVIOUS_BLOCK_UUID \
    AGENTD_STATUS_ERROR_MACRO(AGENTD_SERVICE_DATASERVICE, 0x0038U)

/**
 * \brief Invalid previous block field.
 */
#define AGENTD_ERROR_DATASERVICE_INVALID_PREVIOUS_BLOCK_UUID \
    AGENTD_STATUS_ERROR_MACRO(AGENTD_SERVICE_DATASERVICE, 0x0039U)

/**
 * \brief Missing block uuid field.
 */
#define AGENTD_ERROR_DATASERVICE_MISSING_BLOCK_UUID \
    AGENTD_STATUS_ERROR_MACRO(AGENTD_SERVICE_DATASERVICE, 0x003AU)

/**
 * \brief Invalid block uuid field.
 */
#define AGENTD_ERROR_DATASERVICE_INVALID_BLOCK_UUID \
    AGENTD_STATUS_ERROR_MACRO(AGENTD_SERVICE_DATASERVICE, 0x003BU)

/**
 * \brief Missing transaction id for child transaction.
 */
#define AGENTD_ERROR_DATASERVICE_MISSING_CHILD_TRANSACTION_UUID \
    AGENTD_STATUS_ERROR_MACRO(AGENTD_SERVICE_DATASERVICE, 0x003CU)

/**
 * \brief Missing previous transaction id for child transaction.
 */
#define AGENTD_ERROR_DATASERVICE_MISSING_CHILD_PREVIOUS_TRANSACTION_UUID \
    AGENTD_STATUS_ERROR_MACRO(AGENTD_SERVICE_DATASERVICE, 0x003DU)

/**
 * \brief Missing artifact id for child transaction.
 */
#define AGENTD_ERROR_DATASERVICE_MISSING_CHILD_ARTIFACT_UUID \
    AGENTD_STATUS_ERROR_MACRO(AGENTD_SERVICE_DATASERVICE, 0x003EU)

/**
 * \brief Missing state field for child transaction.
 */
...
/**
 * \brief Invalid response packet size.
 */
#define AGENTD_ERROR_DATASERVICE_RESPONSE_PACKET_INVALID_SIZE \
    AGENTD_STATUS_ERROR_MACRO(AGENTD_SERVICE_DATASERVICE, 0x0042U)

/**
 * \brief Invalid decode response parameter.
 */
