 ...
 * Test that the encode function performs parameter checks.
 */
TEST(dataservice_encode_test, request_global_settings_set)
{
    allocator_options_t alloc_opts;
    vccrypt_buffer_t buffer;
 ...
 * Test that the decoded values match the encoded values.
 */
TEST(dataservice_encode_test, request_global_settings_set_decoded)
{
    allocator_options_t alloc_opts;
    vccrypt_buffer_t buffer;
    const uint8_t val[] = { 0x01, 0x02, 0x03, 0x04 };
    ...
    ASSERT_EQ(DATASERVICE_API_METHOD_APP_GLOBAL_SETTING_WRITE, method);
    ...
    ASSERT_EQ(sizeof(val), req.val_size);

    /* the value should match. */
    EXPECT_EQ(0, memcmp(req.val, val, req.val_size));
 ...
 * Test that the encode function performs parameter checks.
 */
TEST(dataservice_encode_test, request_latest_block_id_get)
{
    allocator_options_t alloc_opts;
    vccrypt_buffer_t buffer;
    uint32_t child = 0x1234;
 ...
 * Test that the decoded values match the encoded values.
 */
TEST(dataservice_encode_test, request_latest_block_id_get_decoded)
{
    allocator_options_t alloc_opts;
    vccrypt_buffer_t buffer;
    ...
    ASSERT_EQ(DATASERVICE_API_METHOD_APP_BLOCK_ID_LATEST_READ, method);
 ...
 * Test that the encode function performs parameter checks.
 */
TEST(dataservice_encode_test, request_root_context_init)
{
    allocator_options_t alloc_opts;
    vccrypt_buffer_t buffer;
 ...
 * Test that the decoded values match the encoded values.
 */
TEST(dataservice_encode_test, request_root_context_init_decoded)
{
    allocator_options_t alloc_opts;
    vccrypt_buffer_t buffer;
    uint64_t max_database_size = 10 * 1024 * 1024;
    ...
    ASSERT_EQ(DATASERVICE_API_METHOD_LL_ROOT_CONTEXT_CREATE, method);
    ...
    EXPECT_EQ(max_database_size, req.max_database_size);

    /* the data dir string should match. */
    EXPECT_STREQ(datadir, req.datadir);
 ...
 * Test that the encode function performs parameter checks.
 */
TEST(dataservice_encode_test, request_root_context_reduce_caps)
{
    allocator_options_t alloc_opts;
    vccrypt_buffer_t buffer;
    BITCAP(caps, DATASERVICE_API_CAP_BITS_MAX);
 ...
 * Test that the decoded values match the encoded values.
 */
TEST(dataservice_encode_test, request_root_context_reduce_caps_decoded)
{
    allocator_options_t alloc_opts;
    vccrypt_buffer_t buffer;
    ...
    ASSERT_EQ(DATASERVICE_API_METHOD_LL_ROOT_CONTEXT_REDUCE_CAPS, method);
 ...
 * Test that the encode function performs parameter checks.
 */
TEST(dataservice_encode_test, request_transaction_drop)
{
    allocator_options_t alloc_opts;
    vccrypt_buffer_t buffer;
    rcpr_uuid txn_id = { .data = {
 ...
 * Test that the decoded values match the encoded values.
 */
TEST(dataservice_encode_test, request_transaction_drop_decoded)
{
    allocator_options_t alloc_opts;
    vccrypt_buffer_t buffer;
    ...
    ASSERT_EQ(DATASERVICE_API_METHOD_APP_PQ_TRANSACTION_DROP, method);
 ...
 * Test that the encode function performs parameter checks.
 */
TEST(dataservice_encode_test, request_transaction_get)
{
    allocator_options_t alloc_opts;
    vccrypt_buffer_t buffer;
    rcpr_uuid txn_id = { .data = {
 ...
 * Test that the decoded values match the encoded values.
 */
TEST(dataservice_encode_test, request_transaction_get_decoded)
{
    allocator_options_t alloc_opts;
    vccrypt_buffer_t buffer;
    ...
    ASSERT_EQ(DATASERVICE_API_METHOD_APP_PQ_TRANSACTION_READ, method);
 ...
 * Test that the encode function performs parameter checks.
 */
TEST(dataservice_encode_test, request_transaction_get_first)
{
    allocator_options_t alloc_opts;
    vccrypt_buffer_t buffer;
    const uint32_t child = 0x1234;
 ...
 * Test that the decoded values match the encoded values.
 */
TEST(dataservice_encode_test, request_transaction_get_first_decoded)
{
    allocator_options_t alloc_opts;
    vccrypt_buffer_t buffer;
    ...
    /* the method should be DATASERVICE_API_METHOD_APP_PQ_TRANSACTION_READ */
    ASSERT_EQ(DATASERVICE_API_METHOD_APP_PQ_TRANSACTION_FIRST_READ, method);
