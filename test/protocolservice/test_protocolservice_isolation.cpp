 ...
 */
TEST_F(protocolservice_isolation_test, block_get_next_id)
{
    uint32_t offset, status;
    uint64_t client_iv = 0;
    uint64_t server_iv = 0;
 ...
 * sentry.
 */
TEST_F(protocolservice_isolation_test, block_get_next_id_end)
{
    uint32_t offset, status;
    uint64_t client_iv = 0;
    uint64_t server_iv = 0;
 ...
 */
TEST_F(protocolservice_isolation_test, block_get_prev_id)
{
    uint32_t offset, status;
    uint64_t client_iv = 0;
    uint64_t server_iv = 0;
 ...
 * sentry.
 */
TEST_F(protocolservice_isolation_test, block_get_prev_id_end)
{
    uint32_t offset, status;
    uint64_t client_iv = 0;
    uint64_t server_iv = 0;
 ...
 */
TEST_F(protocolservice_isolation_test, txn_get_by_id_happy_path)
{
    uint32_t offset, status;
    uint64_t client_iv = 0;
    uint64_t server_iv = 0;
 ...
 */
TEST_F(protocolservice_isolation_test, txn_get_next_id_happy_path)
{
    uint32_t offset, status;
    uint64_t client_iv = 0;
    uint64_t server_iv = 0;
 ...
 * end sentry.
 */
TEST_F(protocolservice_isolation_test, txn_get_next_id_end)
{
    uint32_t offset, status;
    uint64_t client_iv = 0;
    uint64_t server_iv = 0;
 ...
 */
TEST_F(protocolservice_isolation_test, txn_get_prev_id_happy_path)
{
    uint32_t offset, status;
    uint64_t client_iv = 0;
    uint64_t server_iv = 0;
 ...
 * end sentry.
 */
TEST_F(protocolservice_isolation_test, txn_get_prev_id_end)
{
    uint32_t offset, status;
    uint64_t client_iv = 0;
    uint64_t server_iv = 0;
 ...
 */
TEST_F(protocolservice_isolation_test, txn_get_block_id_happy_path)
{
    uint32_t offset, status;
    uint64_t client_iv = 0;
    uint64_t server_iv = 0;
 ...
 */
TEST_F(protocolservice_isolation_test, artifact_first_txn_happy)
{
    uint32_t offset, status;
    uint64_t client_iv = 0;
    uint64_t server_iv = 0;
 ...
 */
TEST_F(protocolservice_isolation_test, artifact_last_txn_happy)
{
    uint32_t offset, status;
    uint64_t client_iv = 0;
    uint64_t server_iv = 0;
 ...
 */
TEST_F(protocolservice_isolation_test, status_happy)
{
    uint32_t offset, status;
    uint64_t client_iv = 0;
    uint64_t server_iv = 0;
 ...
 */
TEST_F(protocolservice_isolation_test, ctrl_auth_entity_add)
{
    uint32_t offset, status;
 ...
 */
TEST_F(protocolservice_isolation_test, ctrl_set_private_key)
{
    uint32_t offset, status;
    const uint8_t entity_id[16] = {
        0xa6, 0xeb, 0x8e, 0x98, 0x5a, 0x84, 0x45, 0x4e,
 ...
 * block assertion.
 */
TEST_F(protocolservice_isolation_test, assert_block_capabilities_check)
{
    uint64_t client_iv = 0;
    uint64_t server_iv = 0;
    uint32_t request_id, offset, status;
    ...
    entity_caps.erase(verb_assert_latest_block_id);
 ...
 */
TEST_F(protocolservice_isolation_test, assert_block_cancel_happy_path)
{
    uint64_t client_iv = 0;
    uint64_t server_iv = 0;
    uint32_t request_id, offset, status;
 ...
 */
TEST_F(protocolservice_isolation_test, extended_api_enable_happy_path)
{
    uint64_t client_iv = 0;
    uint64_t server_iv = 0;
    uint32_t request_id, offset, status;
 ...
 * call to itself.
 */
TEST_F(protocolservice_isolation_test, extended_api_e2e)
{
    uint64_t client_iv = 0;
    uint64_t server_iv = 0;
    uint32_t request_id, offset, status;
    ...
    EXPECT_EQ(UNAUTH_PROTOCOL_REQ_ID_EXTENDED_API_CLIENTREQ, request_id);

    /* decode the client request. */
    ASSERT_EQ(
        AGENTD_STATUS_SUCCESS,
        vcblockchain_protocol_decode_resp_extended_api_client_request(
            &client_resp, &alloc_opts, response.data, response.size));

    /* the request id should be valid. */
    EXPECT_EQ(
        UNAUTH_PROTOCOL_REQ_ID_EXTENDED_API_CLIENTREQ, client_resp.request_id);
    /* the offset should be what we expect. */
    EXPECT_EQ(1UL, client_resp.offset);
    /* the client id should match our authorized id. */
    EXPECT_EQ(0, memcmp(authorized_entity_id, &client_resp.client_id, 16));
    /* the verb id should match. */
    EXPECT_EQ(0, memcmp(&verb_id, &client_resp.verb_id, 16));
    ...
    EXPECT_EQ(
        0,
        memcmp(
            authorized_entity_enc_pubkey_buffer,
    ...
    EXPECT_EQ(
        0,
        memcmp(
            authorized_entity_sign_pubkey_buffer,
            client_resp.client_sign_pubkey.data,
            client_resp.client_sign_pubkey.size));
    /* the request body size should match. */
    ASSERT_EQ(request_body.size, client_resp.request_body.size);
...
TEST_F(protocolservice_isolation_test, extended_api_e2e2)
{
    ...
    EXPECT_EQ(UNAUTH_PROTOCOL_REQ_ID_EXTENDED_API_SENDRECV, request_id);
    EXPECT_EQ(EXPECTED_OFFSET, offset);
    EXPECT_EQ(EXPECTED_RESPONSE_STATUS, status);

    /* decode the body. */
    ASSERT_EQ(
        AGENTD_STATUS_SUCCESS,
        vcblockchain_protocol_decode_resp_extended_api(
            &extresp, &alloc_opts, response.data, response.size));

    /* the request body should match. */
    ASSERT_EQ(request_body.size, extresp.response_body.size);
    EXPECT_EQ(
        0,
        memcmp(
 ...
 */
TEST_F(protocolservice_isolation_test, extended_api_req_unauthorized)
{
    uint64_t client_iv = 0;
    uint64_t server_iv = 0;
    uint32_t request_id, offset, status;
