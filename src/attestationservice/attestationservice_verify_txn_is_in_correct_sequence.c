/**
 * \file
 * attestationservice/attestationservice_verify_txn_is_in_correct_sequence.c
 *
 * \brief Verify that the given transaction would be inserted in a logical
 * sequence for the artifact state and previous transaction id.
 *
