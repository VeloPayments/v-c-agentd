/**
 * \file dataservice/dataservice_encode_request_canonized_transaction_get.c
 *
 * \brief Encode a canonized transaction by id query request.
 *
    ...
    const RCPR_SYM(rcpr_uuid)* txn_id, bool read_cert)
{
    ...
    /* | Canonized Transaction Get packet.                                    */
    /* | ---------------------------------------------------- | ----------- | */
    /* | DATA                                                 | SIZE        | */
    /* | ---------------------------------------------------- | ----------- | */
