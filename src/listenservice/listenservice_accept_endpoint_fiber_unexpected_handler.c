/**
 * \file listenservice/listenservice_accept_endpoint_fiber_unexpected_handler.c
 *
 * \brief Unexpected resume event handler for the accept endpoint fiber.
 *
    ...
    int /*expected_resume_event*/)
{
    listenservice_accept_endpoint_context* ctx =
        (listenservice_accept_endpoint_context*)context;
    ...
    /* for any other resume event, terminate the accept endpoint fiber. */
