/**
 * \file
 * protocolservice/protocolservice_control_api_recvresp_authorized_entity_add.c
 *
 * \brief Receive the response for the authorized entity add control command.
 *
    ...
    int sock, uint32_t* offset, uint32_t* status)
{
    ...
    if (UNAUTH_PROTOCOL_CONTROL_REQ_ID_AUTH_ENTITY_ADD != method)
    {
