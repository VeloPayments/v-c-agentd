/**
 * \file
 * protocolservice/protocolservice_protocol_dnd_artifact_last_transaction_id_get.c
 *
 * \brief Decode and dispatch a get artifact last transaction id get request.
 *
