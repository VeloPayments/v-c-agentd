/**
 * \file protocolservice/protocolservice_api_recvresp_transaction_prev_id_get.c
 *
 * \brief Receive the transaction get prev id response.
 *
    ...
    uint8_t* prev_id)
{
    ...
    *server_iv += 1;
    ...
    if (UNAUTH_PROTOCOL_REQ_ID_TRANSACTION_ID_GET_PREV != ntohl(val[0]))
    {
