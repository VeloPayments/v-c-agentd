/**
 * \file protocolservice/protocolservice_protocol_dnd_transaction_id_prev_get.c
 *
 * \brief Decode and dispatch a get prev transaction id request.
 *
    ...
    const uint8_t* payload, size_t payload_size)
{
    ...
    protocol_req_txn_prev_id_get req;
    ...
    /* decode the request. */
    retval =
        vcblockchain_protocol_decode_req_txn_prev_id_get(
