/**
 * \file protocolservice/protocolservice_api_recvresp_transaction_next_id_get.c
 *
 * \brief Receive the transaction get next id response.
 *
    ...
    uint8_t* next_id)
{
    ...
    *server_iv += 1;
    ...
    if (UNAUTH_PROTOCOL_REQ_ID_TRANSACTION_ID_GET_NEXT != ntohl(val[0]))
    {
