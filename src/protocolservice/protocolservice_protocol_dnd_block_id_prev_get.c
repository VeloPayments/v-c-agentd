/**
 * \file protocolservice/protocolservice_protocol_dnd_block_id_prev_get.c
 *
    ...
    const uint8_t* payload, size_t payload_size)
{
    ...
    protocol_req_block_prev_id_get req;
    ...
    /* decode the request. */
    retval =
        vcblockchain_protocol_decode_req_block_prev_id_get(
