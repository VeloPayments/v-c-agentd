/**
 * \file
 * protocolservice/protocolservice_api_recvresp_artifact_first_txn_id_get.c
 *
 * \brief Receive the artifact get first transaction id response.
 *
    ...
    uint8_t* first_txn_id)
{
    ...
    *server_iv += 1;
    ...
    if (UNAUTH_PROTOCOL_REQ_ID_ARTIFACT_FIRST_TXN_BY_ID_GET != ntohl(val[0]))
    {
