/**
 * \file protocolservice/protocolservice_api_sendreq_status_get.c
 *
 * \brief Send the status get request.
 *
    ...
    const vccrypt_buffer_t* shared_secret)
{
    ...
    uint32_t net_method_id = htonl(UNAUTH_PROTOCOL_REQ_ID_STATUS_GET);
