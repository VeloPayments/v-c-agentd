/**
 * \file protocolservice/protocolservice_api_recvresp_transaction_block_id_get.c
 *
 * \brief Receive the transaction get block id response.
 *
    ...
    uint8_t* block_id)
{
    ...
    *server_iv += 1;
    ...
    if (UNAUTH_PROTOCOL_REQ_ID_TRANSACTION_ID_GET_BLOCK_ID != ntohl(val[0]))
    {
