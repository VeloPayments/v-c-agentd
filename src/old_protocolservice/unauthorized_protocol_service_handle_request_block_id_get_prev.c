/**
 * \file protocolservice/unauthorized_protocol_service_handle_request_block_id_get_prev.c
 *
 * \brief Handle a block id get prev request.
 *
    ...
    const uint8_t* breq, size_t size)
{
    ...
    retval =
        dataservice_api_sendreq_block_get_old(
            ...
            conn->dataservice_child_context, block_id, false);
